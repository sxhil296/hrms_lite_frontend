...
export default function EmployeeTable() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["employees", search, page, department],
    queryFn: () => getAllEmployees(search, page, LIMIT, department),
  ...
  const toggleSelect = (employee_id: string) => {
    setSelected((prev) =>
      prev.includes(employee_id)
        ? prev.filter((item) => item !== employee_id)
        : [...prev, employee_id],
    );
  };
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:justify-between lg:items-center">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Button variant="outline" asChild>
            <Link href="/employees/attendance">Mark Attendance</Link>
          </Button>
        </div>
      </div>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              permanently delete employee details from the
                              database.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
